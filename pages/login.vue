      ...
      <div class="relative z-10 flex flex-col h-full justify-between">
        <div>
          <div class="flex items-center space-x-3">
            ...
            <h2 class="text-2xl font-bold">CoverageX</h2>
          </div>
      ...
      >
        <div class="bg-white p-8 rounded-2xl shadow-xl">
          <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-neutral-900 mt-2">CoverageX</h1>
          ...
          <div class="mt-8 text-center text-sm text-neutral-600">
            <p>This application is only accessible to CoverageX employees.</p>
            <p class="mt-2">
        ...
        <div class="text-center mt-6 text-xs text-neutral-500">
          <p>© 2025 CoverageX. All rights reserved.</p>
